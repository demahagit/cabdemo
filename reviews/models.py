...
class Review(models.Model):
    ...
    user_profile = models.ForeignKey(UserProfile, related_name='user_review', on_delete=models.CASCADE, null=False)
    route = models.ForeignKey(OutstationRoutePage, related_name='page_review', on_delete=models.CASCADE, null=False)
...
class ReviewImage(models.Model):
    ...
    review = models.ForeignKey('Review', related_name='review_image', null=False, on_delete=models.CASCADE)
...
class ReviewVideo(models.Model):
    ...
    upload_date = models.DateTimeField(auto_now_add=True, null=False)
    review = models.ForeignKey('Review', related_name='review_video', null=False, on_delete=models.CASCADE)
